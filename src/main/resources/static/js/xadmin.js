    ...
    $('.left-nav #nav').on('click', 'li', function (event) {
        ...
        if ($(this).children('.sub-menu').length) {
            if ($(this).hasClass('open')) {
                ...
                //$(this).find('.nav_right').html('&#xe697;');//左
                $(this).find('.nav_right').html('<i class="layui-icon layui-icon-left"></i>');//左
                $(this).children('.sub-menu').stop(true, true).slideUp();
                $(this).siblings().children('.sub-menu').slideUp();
            } else {
                $(this).addClass('open');
                //$(this).children('a').find('.nav_right').html('&#xe6a6;');//下
                $(this).find('.nav_right').html('<i class="layui-icon layui-icon-down"></i>');//左
                $(this).children('.sub-menu').stop(true, true).slideDown();
                $(this).siblings().children('.sub-menu').stop(true, true).slideUp();
                //$(this).siblings().find('.nav_right').html('&#xe697;');//左
                $(this).siblings().find('.nav_right').html('<i class="layui-icon layui-icon-left"></i>');//左
